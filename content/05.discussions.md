...
To enhance the accessibility and traceability of our toolbox, we registered it with https://scicrunch.org/ (RRID: SCR_024630), https://bio.tools/ (bio.tools ID: biotools:mmv_im2im) and https://workflowhub.eu/ (TODO).
